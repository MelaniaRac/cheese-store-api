...
@SpringBootTest
@Transactional
class CustomAndDerivedQueriesTest {
    ...
    void findByName(){
        ...
        Optional<CheeseProduct> productFoundByName = cheeseProductRepository.findByCheeseName("NeufChatel");
...
//    @Rollback(value = false)
    void deleteProductWithStockUnit0(){
        ...
        System.out.println("Number of deleted products with StockUnit=0" + Long.toString(numberProductsDeleted));
