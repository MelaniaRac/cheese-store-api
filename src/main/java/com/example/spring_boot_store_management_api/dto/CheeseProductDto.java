...
public class CheeseProductDto {
    ...
    // no reason to contain JPA annotations, as the DTO does not communicate w/ the db
        ...
        //TODOo : given it's a String, it should not accept numbers
        private String cheeseName;
        // TODOo: create handlers for errors the price be at least 0,01 RON (AC: from a legal pov, the discount cannot be 100%)
    ...
    // TODOo: shouldn't I move it someplace else? it's not a cheese product related field
